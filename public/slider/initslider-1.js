jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        navthumbtitlecss:"display:block;position:relative;margin-top: 20px; padding:2px 4px;text-align:center;font:bold 14px Arial,Helvetica,sans-serif;color:#fff;",
