    ...
    $.fn.amazingslider = function(options) {
                ...
                if (this.options.navstyle == "bullets") {
                    ...
                    $(imgLoader).load(function() {
                        if (instance.options.navthumbstyle != "textonly") {
                            ...
                            $bullet.append("<div class='amazingslider-bullet-image-" + instance.id + "' style='display:block;position:absolute;margin: 4px 0 0 4px;width:53px;height:53px;overflow:hidden;'><img src='" + instance.elemArray[index][ELEM_THUMBNAIL] + "' style='" +
                                style + "' /></div>");
        ...
        this.each(function() {
            ...
            var defaultOptions = {
                ...
                navthumbtitlecss: "border-radius:10px;display:block;position:relative;padding:2px 4px;text-align:left;font:bold 14px Arial,Helvetica,sans-serif;color:#333;",
